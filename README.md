...
Sample project for the "Cypress, from zero to the cloud" course of the Talking About Test online school

## Pre-requirements

It is required to have git, Node.js and npm installed to clone and run this project.

> i have used versions `2.42.1`, `v20.13.1` and `10.8.1`of git, Node.js and npm, respectively. I suggest you use the same or later LTS versions.
